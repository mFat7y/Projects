...
import com.fat7y.sunshine.data.WeatherContract;
import com.fat7y.sunshine.data.WeatherContract.WeatherEntry;
    ...
    protected String[] doInBackground(String... params) {
        ...
        try {
            ...
            Uri builtUri = Uri.parse(FORECAST_BASE_URL).buildUpon()
                    ...
                    .appendQueryParameter(APPID_PARAM, "ea574594b9d36ab688642d5fbeab847e")
                    .build();
